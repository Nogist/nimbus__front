                    ...
                    <div className="w-90 md:w-4/5 mx-auto">
                        <form onSubmit={submitMessage}>
                            <div className="w-90 mx-auto">
                                ...
                                <input className="w-full lg:w-full mt-5 pl-3 text-base h-12 text-gray-600 rounded-md border border-charity-color4 focus:border-2 focus:outline-none focus:border-primary2 shadow-sm" type="text" name="name" placeholder="Full Name" onChange={handleOnChange} value={contactInfo.name} autoComplete="off" required/>
                                <input className="w-full lg:w-full mt-5 pl-3 text-base h-12 rounded-md border border-charity-color4 focus:outline-none focus:border-2 focus:border-primary2 shadow-sm" type="email" name="email" placeholder="Email address" onChange={handleOnChange} value={contactInfo.email} autoComplete="off" required/>
