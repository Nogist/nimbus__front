...
function CreateTeamProfile(props) {
        ...
        <div className="fixed overflow-auto top-2/4 left-2/4 w-700 h-550 bg-white z-80 mt-275 ml-350">
            ...
            <form onSubmit={handleFormOnSubmit} className="w-full h-[calc(100%_-_40px)] overflow-auto relative">
                <div className="flex w-full h-[calc(100%_-_40px)] py-10">
                    <div className="flex justify-center items-center text-center relative h-full w-2/4">
                        <img src={image} alt="" className='object-cover w-4/5 cursor-pointer h-full border-2 border-dotted border-primary3'/>
                ...
                <div className="bottom-0 justify-between bg-primary13 w-full h-10 flex py-1 px-7 z-30 left-0">
                    <button className='text-white rounded-md border border-primary3 w-12 bg-primary3 hover:text-primary3 hover:bg-transparent' onClick={props.onClick}>Close</button>
                    <button className='text-white rounded-md border border-primary3 w-12 bg-primary3 hover:text-primary3 hover:bg-transparent' type="submit">Add</button>
                </div>
            </form>
        </div>
    </>
